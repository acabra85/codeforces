...
public class CardGame1097ATest {
    ...
    public void should_return_yes_0() throws IOException {
        CardGame1097A.Solution.Help help = CardGame1097A.Solution.Help.of("below1000/1097A_0.txt");
        Assert.assertEquals("YES", CardGame1097A.Solution.solution(help));
    }

    @Test
    public void should_return_yes_1() throws IOException {
        CardGame1097A.Solution.Help help = CardGame1097A.Solution.Help.of("below1000/1097A_2.txt");
        Assert.assertEquals("YES", CardGame1097A.Solution.solution(help));
    }

    @Test
    public void should_return_no_0() throws IOException {
        CardGame1097A.Solution.Help help = CardGame1097A.Solution.Help.of("below1000/1097A_1.txt");
